from projekt.narzedzia import get_sasiedzi, id_to_pos
import random
...
def create_state(package1, package2):
    starting_state["jednostki"].append(get_miasto(package1, "client1"))
    starting_state["jednostki"].append(get_miasto(package2, "client2"))
