...
from projekt.narzedzia import pozycja_myszy_na_surface, get_sasiedzi
...
class BuildingBlock(pygame.sprite.Sprite):
    ...
    def event(self, mouse_pos, x, y):
        if self.rect.collidepoint(mouse_pos):
            ...
            if self.buy.rect.collidepoint(mouse_pos):
                self.dirty = True
                Mapa().move_flag = self.load_squad()
                print(Mapa().move_flag)
